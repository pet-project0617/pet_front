...
import SaleReview from "pages/inform/weekly/SaleReview";

import InqueryPage from "pages/inform/notice/InqueryPage";
...
import HomeBreedServicePage from "pages/intro/HomeBreedServicePage";
import AbandonedBreedServicePage from "pages/intro/AbandonedBreedServicePage";
    ...
    <>
      ...
      <div className="content_wrapper">
        <Routes>
          ...
          />
          <Route
            path={URL.SUPPORT_DOWNLOAD_CREATE2}
            element={<EgovSupportDownloadCreate2 />}
          />
