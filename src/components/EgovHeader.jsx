    ...
    return (
        ...
        <div className="header">
            <div className="inner">
                ...
                <h1 className="logo">
                    <Link to={URL.MAIN} className="w"><img src="/assets/images/logo_sample.png" style={{width:'100px', marginTop:'-50px', marginLeft:'-50px'}} /></Link>  
                </h1>
                <Link to={URL.MAIN} className="ico lnk_go_template" state={{ marginLeft:'20px' }} target="_blank">홈페이지 템플릿 소개 페이지로 이동</Link>

                <div className="gnb">
                    <h2 className="blind">주메뉴</h2>
                    <ul>
                        <li><NavLink to={URL.ABOUT} className={({ isActive }) => (isActive ? "cur" : "")}>사이트소개</NavLink></li>
                        <li><NavLink to={URL.INTRO} className={({ isActive }) => (isActive ? "cur" : "")}>분양</NavLink></li>
                        <li><NavLink to={URL.SUPPORT} className={({ isActive }) => (isActive ? "cur" : "")}>마켓</NavLink></li>
                        <li><NavLink to={URL.INFORM} className={({ isActive }) => (isActive ? "cur" : "")}>후기</NavLink></li>
                        {sessionUserSe ==='USR' &&
            ...
            <div className="all_menu WEB closed">
                ...
                <div className="inner">
                    <div className="col">
                        <h3>소개</h3>
                        <ul>
                            <li><NavLink to={URL.ABOUT_SITE} className={({ isActive }) => (isActive ? "cur" : "")}>사이트소개</NavLink></li>
                    ...
                    <div className="col">
                        ...
                        <ul>
                            ...
                            <li><NavLink to={URL.SUPPORT_QNA} className={({ isActive }) => (isActive ? "cur" : "")}>중고거래</NavLink></li>
                    ...
                    <div className="col">
                        ...
                        <ul>
                            ...
                            <li><NavLink to={URL.INFORM_WEEKLY} className={({ isActive }) => (isActive ? "cur" : "")}>마켓 후기</NavLink></li>
                            <li><NavLink to={URL.INFORM_NOTICE} className={({ isActive }) => (isActive ? "cur" : "")}>입양 후기</NavLink></li>
                            <li><NavLink to={URL.INFORM_GALLERY} className={({ isActive }) => (isActive ? "cur" : "")}>질문</NavLink></li>
                        </ul>
                    </div>
                    {sessionUserSe ==='USR' &&
                        <div className="col">
            ...
            <div className="all_menu Mobile closed">
                <div className="user_info_m">
                    ...
                    {/* 로그인 : 로그인 정보 없을 때 */}
                    {!sessionUserId &&
                        <button onClick={logInHandler} className="">로그인</button>
                    }
                ...
                <div className="menu">
                    ...
                    <h3><Link to={URL.INTRO}>분양</Link></h3>
                    <div className="submenu closed">
                        <ul>
                            <li><NavLink to={URL.INTRO_WORKS} className={({ isActive }) => (isActive ? "cur" : "")}> 유기동물 분양</NavLink></li>
                            <li><NavLink to={URL.INTRO_SERVICE} className={({ isActive }) => (isActive ? "cur" : "")}>가정 분양</NavLink></li>
                    ...
                    <h3><Link to={URL.SUPPORT}>마켓</Link></h3>
                    <div className="submenu closed">
                        <ul>
                            <li><NavLink to={URL.SUPPORT_DOWNLOAD} className={({ isActive }) => (isActive ? "cur" : "")}>무료나눔</NavLink></li>
                            <li><NavLink to={URL.SUPPORT_QNA} className={({ isActive }) => (isActive ? "cur" : "")}>중고거래</NavLink></li>
                    ...
                    <h3><Link to={URL.INFORM}>후기</Link></h3>
                    <div className="submenu closed">
                        <ul>
                            <li><NavLink to={URL.INFORM_DAILY}>마켓 후기</NavLink></li>
